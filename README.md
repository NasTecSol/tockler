...
Nova is free and open-source software. If you find it useful, please consider supporting its development:
...
Nova is built with modern web technologies:
...
Nova is licensed under the GNU General Public License v2.0. See the [LICENSE](LICENSE) file for details.
